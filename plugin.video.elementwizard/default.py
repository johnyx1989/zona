...
ADDON=xbmcaddon.Addon(id='plugin.video.elementwizard')
...
def CATEGORIES():
    link = OPEN_URL('https://dl.dropbox.com/s/sv22jlbcwnj4sph/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Element Wizard","Downloading ",'', 'Please Wait')
