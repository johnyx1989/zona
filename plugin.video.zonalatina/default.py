...
wolf = 'aHR0cDovL3pvbmFsYXRpbmEudXMvem9uYWxhdGluYS9zZWNjaW9uZXMvbWFpbi5waHA='.decode('base64')
...
SOURCE = [{"url": "https://dl.dropbox.com/s/r1nlafz3w08x009/main.xml", "fanart": "http://imgur.com/asT6ECh"}]

SOURCES = [{"url": wolf, "fanart": "http://imgur.com/asT6ECh"}]
...
def makeRequest(url, headers=None):
        try:
            if headers is None:
                headers = {'User-agent' : 'plugin.video.zonalatina'}
            ...
            if hasattr(e, 'code'):
                ...
                xbmc.executebuiltin("XBMC.Notification(ZonaLatina,We failed with error code - "+str(e.code)+",10000,"+icon+")")
            elif hasattr(e, 'reason'):
                addon_log('We failed to reach a server.')
                addon_log('Reason: %s' %e.reason)
                xbmc.executebuiltin("XBMC.Notification(ZonaLatina,We failed to reach a server. - "+str(e.reason)+",10000,"+icon+")")
...
#                            urllib2.getproxies= lambda: {}
                        ...
                        req.add_header('User-Agent', 'plugin.video.zonalatina')
                        proxytouse=None
